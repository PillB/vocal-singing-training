...
**Generated:** 2026-07-17T20:26:22.631Z
...
| 22 | `v1-diction/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v1-diction/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v1-diction/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v1-diction/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v1-diction/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v1-diction/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v1-diction/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v1-diction/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v1-diction/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v1-diction/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v1-diction/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v1-diction/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v1-diction/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v1-diction/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=volumeSteady showPitch=false soundGated=false airHold=false wallClockPhase=true allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v2-volume/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | phase timer may tick; not sound-count | hold=null remain=null engHold=0 |
| 9 | `v2-volume/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=null live=true |
...
| 12 | `v2-volume/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v2-volume/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v2-volume/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v2-volume/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v2-volume/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
...
**Notes:**
- Profile mode=countPace showPitch=false soundGated=false airHold=false wallClockPhase=true allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v3-soft-palate/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | phase timer may tick; not sound-count | hold=null remain=null engHold=0 |
| 9 | `v3-soft-palate/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=null live=true |
...
| 11 | `v3-soft-palate/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v3-soft-palate/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v3-soft-palate/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v3-soft-palate/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v3-soft-palate/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v3-soft-palate/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v3-soft-palate/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v3-soft-palate/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v3-soft-palate/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v3-soft-palate/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v3-soft-palate/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v3-soft-palate/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v3-soft-palate/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v3-soft-palate/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v3-soft-palate/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v3-soft-palate/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v3-soft-palate/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v3-soft-palate/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v3-soft-palate/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v3-soft-palate/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v3-soft-palate/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v3-soft-palate/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v3-soft-palate/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v3-soft-palate/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v3-soft-palate/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=articulationContrast showPitch=false soundGated=false airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain 90→88 progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v4-articulation-pen/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | stable live | hold=null remain=90 engHold=0 |
| 9 | `v4-articulation-pen/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=88 live=true |
...
| 11 | `v4-articulation-pen/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v4-articulation-pen/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v4-articulation-pen/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v4-articulation-pen/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v4-articulation-pen/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v4-articulation-pen/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v4-articulation-pen/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v4-articulation-pen/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v4-articulation-pen/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v4-articulation-pen/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v4-articulation-pen/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v4-articulation-pen/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v4-articulation-pen/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v4-articulation-pen/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v4-articulation-pen/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v4-articulation-pen/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v4-articulation-pen/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v4-articulation-pen/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v4-articulation-pen/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v4-articulation-pen/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v4-articulation-pen/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v4-articulation-pen/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v4-articulation-pen/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v4-articulation-pen/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v4-articulation-pen/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=recordOnly showPitch=false soundGated=false airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v5-neutral-ears/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | stable live | hold=null remain=null engHold=0 |
| 9 | `v5-neutral-ears/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=null live=true |
...
| 11 | `v5-neutral-ears/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v5-neutral-ears/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v5-neutral-ears/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v5-neutral-ears/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v5-neutral-ears/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v5-neutral-ears/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v5-neutral-ears/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v5-neutral-ears/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v5-neutral-ears/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v5-neutral-ears/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v5-neutral-ears/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v5-neutral-ears/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v5-neutral-ears/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v5-neutral-ears/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v5-neutral-ears/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v5-neutral-ears/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v5-neutral-ears/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v5-neutral-ears/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v5-neutral-ears/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v5-neutral-ears/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v5-neutral-ears/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v5-neutral-ears/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v5-neutral-ears/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v5-neutral-ears/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v5-neutral-ears/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=speechEnergy showPitch=false soundGated=false airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v6-connect/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | stable live | hold=null remain=null engHold=0 |
| 9 | `v6-connect/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=null live=true |
...
| 12 | `v6-connect/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v6-connect/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v6-connect/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v6-connect/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v6-connect/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
...
**Notes:**
- Profile mode=reviewSession showPitch=false soundGated=false airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v7-record-review/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | stable live | hold=null remain=null engHold=0 |
| 9 | `v7-record-review/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=null live=true |
...
| 11 | `v7-record-review/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v7-record-review/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v7-record-review/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v7-record-review/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v7-record-review/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v7-record-review/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v7-record-review/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v7-record-review/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v7-record-review/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v7-record-review/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v7-record-review/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v7-record-review/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v7-record-review/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v7-record-review/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v7-record-review/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v7-record-review/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v7-record-review/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v7-record-review/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v7-record-review/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v7-record-review/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v7-record-review/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v7-record-review/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v7-record-review/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v7-record-review/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v7-record-review/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=metronomeSpeech showPitch=false soundGated=false airHold=false wallClockPhase=true allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain 60→58 progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v8-fluency-metaphors/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | phase timer may tick; not sound-count | hold=null remain=60 engHold=0 |
| 9 | `v8-fluency-metaphors/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=58 live=true |
...
| 11 | `v8-fluency-metaphors/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v8-fluency-metaphors/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v8-fluency-metaphors/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v8-fluency-metaphors/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v8-fluency-metaphors/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v8-fluency-metaphors/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v8-fluency-metaphors/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v8-fluency-metaphors/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v8-fluency-metaphors/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v8-fluency-metaphors/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v8-fluency-metaphors/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v8-fluency-metaphors/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v8-fluency-metaphors/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v8-fluency-metaphors/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v8-fluency-metaphors/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v8-fluency-metaphors/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v8-fluency-metaphors/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v8-fluency-metaphors/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v8-fluency-metaphors/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v8-fluency-metaphors/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v8-fluency-metaphors/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v8-fluency-metaphors/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v8-fluency-metaphors/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v8-fluency-metaphors/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v8-fluency-metaphors/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=weekPlan showPitch=false soundGated=false airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→5 (restored)
...
**Notes:**
- Profile mode=pauseDetect showPitch=false soundGated=false airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v10-power-pause/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | stable live | hold=null remain=null engHold=0 |
| 9 | `v10-power-pause/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=null live=true |
...
| 11 | `v10-power-pause/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v10-power-pause/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v10-power-pause/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v10-power-pause/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v10-power-pause/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v10-power-pause/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v10-power-pause/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v10-power-pause/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v10-power-pause/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v10-power-pause/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v10-power-pause/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v10-power-pause/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v10-power-pause/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v10-power-pause/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v10-power-pause/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v10-power-pause/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v10-power-pause/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v10-power-pause/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v10-power-pause/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v10-power-pause/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v10-power-pause/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v10-power-pause/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v10-power-pause/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v10-power-pause/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v10-power-pause/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=fillerDetect showPitch=false soundGated=false airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v11-kill-fillers/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | stable live | hold=null remain=null engHold=0 |
| 9 | `v11-kill-fillers/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=null live=true |
...
| 12 | `v11-kill-fillers/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v11-kill-fillers/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v11-kill-fillers/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v11-kill-fillers/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v11-kill-fillers/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
...
**Notes:**
- Profile mode=pitchContour showPitch=true soundGated=true airHold=false wallClockPhase=false allowManual=true
...
| 9 | `v12-melodic-speech/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | hold/progress stays ~0 without air/Space | hold=null remain=null engHold=0 |
| 10 | `v12-melodic-speech/05_silence_after_2s.png` | Silence gate t=2s still silent | hold/progress still ~0 | hold=null remain=null live=true |
...
| 15 | `v12-melodic-speech/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=false |
...
**Notes:**
- Profile mode=volumeLadder showPitch=false soundGated=false airHold=false wallClockPhase=true allowManual=true
- Mic drag 9→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain 8→6 progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v13-volume-ladder/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | phase timer may tick; not sound-count | hold=null remain=8 engHold=0 |
| 9 | `v13-volume-ladder/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=6 live=true |
...
| 11 | `v13-volume-ladder/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v13-volume-ladder/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v13-volume-ladder/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v13-volume-ladder/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v13-volume-ladder/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v13-volume-ladder/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v13-volume-ladder/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v13-volume-ladder/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v13-volume-ladder/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v13-volume-ladder/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v13-volume-ladder/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v13-volume-ladder/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v13-volume-ladder/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v13-volume-ladder/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v13-volume-ladder/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v13-volume-ladder/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v13-volume-ladder/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v13-volume-ladder/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v13-volume-ladder/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v13-volume-ladder/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v13-volume-ladder/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v13-volume-ladder/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v13-volume-ladder/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v13-volume-ladder/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v13-volume-ladder/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=keyPointPace showPitch=false soundGated=false airHold=false wallClockPhase=true allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v14-pace-variation/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | phase timer may tick; not sound-count | hold=null remain=null engHold=0 |
| 9 | `v14-pace-variation/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=null live=true |
...
| 11 | `v14-pace-variation/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v14-pace-variation/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v14-pace-variation/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v14-pace-variation/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v14-pace-variation/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v14-pace-variation/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v14-pace-variation/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v14-pace-variation/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v14-pace-variation/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v14-pace-variation/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v14-pace-variation/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v14-pace-variation/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v14-pace-variation/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v14-pace-variation/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v14-pace-variation/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v14-pace-variation/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v14-pace-variation/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v14-pace-variation/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v14-pace-variation/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v14-pace-variation/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v14-pace-variation/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v14-pace-variation/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v14-pace-variation/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v14-pace-variation/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v14-pace-variation/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=gestureReps showPitch=false soundGated=false airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v15-gestures/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | stable live | hold=null remain=null engHold=0 |
| 9 | `v15-gestures/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=null live=true |
...
| 12 | `v15-gestures/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v15-gestures/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v15-gestures/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v15-gestures/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v15-gestures/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
...
**Notes:**
- Profile mode=facePhases showPitch=false soundGated=false airHold=false wallClockPhase=true allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain 40→38 progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v16-facial-expression/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | phase timer may tick; not sound-count | hold=null remain=40 engHold=0 |
| 9 | `v16-facial-expression/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=38 live=true |
...
| 11 | `v16-facial-expression/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v16-facial-expression/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v16-facial-expression/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v16-facial-expression/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v16-facial-expression/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v16-facial-expression/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v16-facial-expression/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v16-facial-expression/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v16-facial-expression/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v16-facial-expression/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v16-facial-expression/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v16-facial-expression/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v16-facial-expression/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v16-facial-expression/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v16-facial-expression/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v16-facial-expression/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v16-facial-expression/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v16-facial-expression/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v16-facial-expression/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v16-facial-expression/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v16-facial-expression/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v16-facial-expression/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v16-facial-expression/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v16-facial-expression/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v16-facial-expression/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=concisionGate showPitch=false soundGated=false airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v17-strategic-concision/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | stable live | hold=null remain=null engHold=0 |
| 9 | `v17-strategic-concision/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=null live=true |
...
| 11 | `v17-strategic-concision/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v17-strategic-concision/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v17-strategic-concision/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v17-strategic-concision/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v17-strategic-concision/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v17-strategic-concision/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v17-strategic-concision/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v17-strategic-concision/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v17-strategic-concision/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v17-strategic-concision/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v17-strategic-concision/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v17-strategic-concision/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v17-strategic-concision/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v17-strategic-concision/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v17-strategic-concision/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v17-strategic-concision/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v17-strategic-concision/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v17-strategic-concision/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v17-strategic-concision/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v17-strategic-concision/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v17-strategic-concision/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v17-strategic-concision/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v17-strategic-concision/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v17-strategic-concision/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v17-strategic-concision/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=storyTimer showPitch=false soundGated=false airHold=false wallClockPhase=true allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain 40→38 progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v18-story-peak/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | phase timer may tick; not sound-count | hold=null remain=40 engHold=0 |
| 9 | `v18-story-peak/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=38 live=true |
...
| 11 | `v18-story-peak/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v18-story-peak/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v18-story-peak/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v18-story-peak/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v18-story-peak/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v18-story-peak/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v18-story-peak/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v18-story-peak/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v18-story-peak/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v18-story-peak/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v18-story-peak/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v18-story-peak/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v18-story-peak/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v18-story-peak/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v18-story-peak/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v18-story-peak/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v18-story-peak/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v18-story-peak/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v18-story-peak/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v18-story-peak/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v18-story-peak/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v18-story-peak/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v18-story-peak/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v18-story-peak/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v18-story-peak/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=authorityLand showPitch=false soundGated=false airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v19-authority-close/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | stable live | hold=null remain=null engHold=0 |
| 9 | `v19-authority-close/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=null live=true |
...
| 11 | `v19-authority-close/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v19-authority-close/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v19-authority-close/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v19-authority-close/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v19-authority-close/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v19-authority-close/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v19-authority-close/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v19-authority-close/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v19-authority-close/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v19-authority-close/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v19-authority-close/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v19-authority-close/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v19-authority-close/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v19-authority-close/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v19-authority-close/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v19-authority-close/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v19-authority-close/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v19-authority-close/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v19-authority-close/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v19-authority-close/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v19-authority-close/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v19-authority-close/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v19-authority-close/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v19-authority-close/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v19-authority-close/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=energyMatch showPitch=false soundGated=false airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→5 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain 30→28 progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `v20-energy-match/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | stable live | hold=null remain=30 engHold=0 |
| 9 | `v20-energy-match/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=28 live=true |
...
| 11 | `v20-energy-match/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=null |
| 12 | `v20-energy-match/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `v20-energy-match/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `v20-energy-match/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `v20-energy-match/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `v20-energy-match/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 17 | `v20-energy-match/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 18 | `v20-energy-match/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 19 | `v20-energy-match/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 20 | `v20-energy-match/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 21 | `v20-energy-match/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 22 | `v20-energy-match/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 23 | `v20-energy-match/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 24 | `v20-energy-match/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 25 | `v20-energy-match/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 26 | `v20-energy-match/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 27 | `v20-energy-match/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 28 | `v20-energy-match/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 29 | `v20-energy-match/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 30 | `v20-energy-match/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 31 | `v20-energy-match/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 32 | `v20-energy-match/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 33 | `v20-energy-match/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 34 | `v20-energy-match/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 35 | `v20-energy-match/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=pitchHold showPitch=true soundGated=true airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→2 (restored)
- Silence 2s: airHold=false gated=true hold 0→0 remain null→null progress 0→0 PASS
- Space assist disabled on pure pitch highway (product)
- Space long: live mid/after=true/true manualChip=false engManual=false hold=0; short tap live=true; assistAllowed=false
...
| 9 | `s1-vocal-fry/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | hold/progress stays ~0 without air/Space | hold=0 remain=null engHold=0 |
| 10 | `s1-vocal-fry/05_silence_after_2s.png` | Silence gate t=2s still silent | hold/progress still ~0 | hold=0 remain=null live=true |
...
| 15 | `s1-vocal-fry/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=false |
...
| 23 | `s2-solfege-chords/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 24 | `s2-solfege-chords/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 25 | `s2-solfege-chords/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 26 | `s2-solfege-chords/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 27 | `s2-solfege-chords/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 28 | `s2-solfege-chords/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 29 | `s2-solfege-chords/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 30 | `s2-solfege-chords/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 31 | `s2-solfege-chords/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 32 | `s2-solfege-chords/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 33 | `s2-solfege-chords/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 34 | `s2-solfege-chords/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 35 | `s2-solfege-chords/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 36 | `s2-solfege-chords/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=pitchSong showPitch=true soundGated=true airHold=false wallClockPhase=false allowManual=true
- Mic drag 9→2 (restored)
- Silence 2s: airHold=false gated=true hold null→null remain null→null progress 0→0 PASS
- Space assist disabled on pure pitch highway (product)
- Space long: live mid/after=true/true manualChip=false engManual=false hold=null; short tap live=true; assistAllowed=false
...
| 9 | `s3-song-stanzas/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | hold/progress stays ~0 without air/Space | hold=null remain=null engHold=0 |
| 10 | `s3-song-stanzas/05_silence_after_2s.png` | Silence gate t=2s still silent | hold/progress still ~0 | hold=null remain=null live=true |
...
| 15 | `s3-song-stanzas/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=false |
...
- Space long: live mid/after=true/true manualChip=true engManual=true hold=1.2; short tap live=true; assistAllowed=true
...
| 16 | `s15-sh-air-ladder/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=2.3 status=En vivo manual=false |
...
**Notes:**
- Profile mode=scaleSteps showPitch=true soundGated=true airHold=false wallClockPhase=false allowManual=true
- Mic drag 6→2 (restored)
- Silence 2s: airHold=false gated=true hold null→null remain null→null progress 0→0 PASS
- Space assist disabled on pure pitch highway (product)
- Space long: live mid/after=true/true manualChip=false engManual=false hold=null; short tap live=true; assistAllowed=false
...
| 9 | `s16-major-scale-coord/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | hold/progress stays ~0 without air/Space | hold=null remain=null engHold=0 |
| 10 | `s16-major-scale-coord/05_silence_after_2s.png` | Silence gate t=2s still silent | hold/progress still ~0 | hold=null remain=null live=true |
...
| 12 | `s16-major-scale-coord/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=false hold=null |
...
| 15 | `s16-major-scale-coord/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=false |
| 16 | `s16-major-scale-coord/07_space_short_release.png` | After short Space release | Still live | live=true |
| 17 | `s16-major-scale-coord/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 18 | `s16-major-scale-coord/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 19 | `s16-major-scale-coord/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 20 | `s16-major-scale-coord/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 21 | `s16-major-scale-coord/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 22 | `s16-major-scale-coord/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 23 | `s16-major-scale-coord/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 24 | `s16-major-scale-coord/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 25 | `s16-major-scale-coord/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 26 | `s16-major-scale-coord/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 27 | `s16-major-scale-coord/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 28 | `s16-major-scale-coord/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 29 | `s16-major-scale-coord/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 30 | `s16-major-scale-coord/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 31 | `s16-major-scale-coord/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 32 | `s16-major-scale-coord/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 33 | `s16-major-scale-coord/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 34 | `s16-major-scale-coord/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 35 | `s16-major-scale-coord/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 36 | `s16-major-scale-coord/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=sovtFlow showPitch=false soundGated=true airHold=false wallClockPhase=false allowManual=true
- Mic drag 9→2 (restored)
- Silence 2s: airHold=false gated=true hold null→null remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=null; short tap live=true; assistAllowed=true
...
| 8 | `s4-lip-trills/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | hold/progress stays ~0 without air/Space | hold=null remain=null engHold=0 |
| 9 | `s4-lip-trills/05_silence_after_2s.png` | Silence gate t=2s still silent | hold/progress still ~0 | hold=null remain=null live=true |
...
| 12 | `s4-lip-trills/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `s4-lip-trills/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `s4-lip-trills/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `s4-lip-trills/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `s4-lip-trills/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
...
**Notes:**
- Profile mode=sirenRange showPitch=true soundGated=true airHold=false wallClockPhase=false allowManual=true
- Mic drag 9→2 (restored)
- Silence 2s: airHold=false gated=true hold null→null remain null→null progress 0→0 PASS
- Space assist disabled on pure pitch highway (product)
- Space long: live mid/after=true/true manualChip=false engManual=false hold=null; short tap live=true; assistAllowed=false
...
| 9 | `s5-sirens/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | hold/progress stays ~0 without air/Space | hold=null remain=null engHold=0 |
| 10 | `s5-sirens/05_silence_after_2s.png` | Silence gate t=2s still silent | hold/progress still ~0 | hold=null remain=null live=true |
...
| 15 | `s5-sirens/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=false |
...
| 8 | `s6-straw/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | hold/progress stays ~0 without air/Space | hold=null remain=null engHold=0 |
| 9 | `s6-straw/05_silence_after_2s.png` | Silence gate t=2s still silent | hold/progress still ~0 | hold=null remain=null live=true |
...
| 12 | `s6-straw/06_space_long_release.png` | Short release after long hold | Still live; grace may keep assist briefly | live=true manual=false |
| 13 | `s6-straw/07_space_short_before.png` | Before short Space tap | Quick down/up assist pulse | ready |
| 14 | `s6-straw/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 15 | `s6-straw/07_space_short_release.png` | After short Space release | Still live | live=true |
| 16 | `s6-straw/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
...
**Notes:**
- Profile mode=humTargets showPitch=true soundGated=true airHold=false wallClockPhase=false allowManual=true
- Mic drag 9→2 (restored)
- Silence 2s: airHold=false gated=true hold null→null remain null→null progress 0→0 PASS
- Space assist disabled on pure pitch highway (product)
- Space long: live mid/after=true/true manualChip=false engManual=false hold=null; short tap live=true; assistAllowed=false
...
| 9 | `s7-humming/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | hold/progress stays ~0 without air/Space | hold=null remain=null engHold=0 |
| 10 | `s7-humming/05_silence_after_2s.png` | Silence gate t=2s still silent | hold/progress still ~0 | hold=null remain=null live=true |
...
| 12 | `s7-humming/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=false hold=null |
...
| 15 | `s7-humming/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=false |
| 16 | `s7-humming/07_space_short_release.png` | After short Space release | Still live | live=true |
| 17 | `s7-humming/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 18 | `s7-humming/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 19 | `s7-humming/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 20 | `s7-humming/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 21 | `s7-humming/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 22 | `s7-humming/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 23 | `s7-humming/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 24 | `s7-humming/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 25 | `s7-humming/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 26 | `s7-humming/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 27 | `s7-humming/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 28 | `s7-humming/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 29 | `s7-humming/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 30 | `s7-humming/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 31 | `s7-humming/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 32 | `s7-humming/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 33 | `s7-humming/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 34 | `s7-humming/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 35 | `s7-humming/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 36 | `s7-humming/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=breathS showPitch=true soundGated=true airHold=true wallClockPhase=false allowManual=true
- Mic drag 9→2 (restored)
- Silence 2s: airHold=true gated=true hold 0→0 remain null→null progress 0→0 PASS
- Space long: live mid/after=true/true manualChip=true engManual=true hold=1.2; short tap live=true; assistAllowed=true
...
| 9 | `s8-breath-support/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | hold/progress stays ~0 without air/Space | hold=0 remain=null engHold=0 |
| 10 | `s8-breath-support/05_silence_after_2s.png` | Silence gate t=2s still silent | hold/progress still ~0 | hold=0 remain=null live=true |
...
| 12 | `s8-breath-support/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=true hold=1.2 |
...
| 15 | `s8-breath-support/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=true |
| 16 | `s8-breath-support/07_space_short_release.png` | After short Space release | Still live | live=true |
| 17 | `s8-breath-support/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=2.5 status=En vivo manual=false |
| 18 | `s8-breath-support/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=3.7 live=true |
| 19 | `s8-breath-support/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=3.8 status=En vivo manual=false |
...
| 9 | `s10-five-note/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | hold/progress stays ~0 without air/Space | hold=null remain=null engHold=0 |
| 10 | `s10-five-note/05_silence_after_2s.png` | Silence gate t=2s still silent | hold/progress still ~0 | hold=null remain=null live=true |
...
| 12 | `s10-five-note/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=false hold=null |
...
| 15 | `s10-five-note/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=false |
| 16 | `s10-five-note/07_space_short_release.png` | After short Space release | Still live | live=true |
| 17 | `s10-five-note/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 18 | `s10-five-note/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 19 | `s10-five-note/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 20 | `s10-five-note/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 21 | `s10-five-note/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 22 | `s10-five-note/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 23 | `s10-five-note/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 24 | `s10-five-note/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 25 | `s10-five-note/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 26 | `s10-five-note/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 27 | `s10-five-note/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 28 | `s10-five-note/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 29 | `s10-five-note/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 30 | `s10-five-note/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 31 | `s10-five-note/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 32 | `s10-five-note/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 33 | `s10-five-note/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 34 | `s10-five-note/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 35 | `s10-five-note/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 36 | `s10-five-note/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=dynamicSwell showPitch=true soundGated=false airHold=false wallClockPhase=true allowManual=true
- Mic drag 9→2 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain null→null progress 0→0 PASS
- Space assist disabled on pure pitch highway (product)
- Space long: live mid/after=true/true manualChip=false engManual=false hold=null; short tap live=true; assistAllowed=false
...
| 9 | `s11-dynamics/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | phase timer may tick; not sound-count | hold=null remain=null engHold=0 |
| 10 | `s11-dynamics/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=null live=true |
...
| 15 | `s11-dynamics/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=false |
...
**Notes:**
- Profile mode=onsetReps showPitch=true soundGated=true airHold=false wallClockPhase=false allowManual=true
- Mic drag 9→2 (restored)
- Silence 2s: airHold=false gated=true hold null→null remain null→null progress 0→0 PASS
- Space assist disabled on pure pitch highway (product)
- Space long: live mid/after=true/true manualChip=false engManual=false hold=null; short tap live=true; assistAllowed=false
...
| 9 | `s12-easy-onset/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | hold/progress stays ~0 without air/Space | hold=null remain=null engHold=0 |
| 10 | `s12-easy-onset/05_silence_after_2s.png` | Silence gate t=2s still silent | hold/progress still ~0 | hold=null remain=null live=true |
...
| 12 | `s12-easy-onset/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=false hold=null |
...
| 15 | `s12-easy-onset/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=false |
| 16 | `s12-easy-onset/07_space_short_release.png` | After short Space release | Still live | live=true |
| 17 | `s12-easy-onset/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 18 | `s12-easy-onset/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 19 | `s12-easy-onset/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 20 | `s12-easy-onset/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 21 | `s12-easy-onset/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 22 | `s12-easy-onset/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 23 | `s12-easy-onset/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 24 | `s12-easy-onset/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 25 | `s12-easy-onset/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 26 | `s12-easy-onset/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 27 | `s12-easy-onset/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 28 | `s12-easy-onset/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 29 | `s12-easy-onset/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 30 | `s12-easy-onset/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 31 | `s12-easy-onset/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 32 | `s12-easy-onset/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 33 | `s12-easy-onset/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 34 | `s12-easy-onset/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 35 | `s12-easy-onset/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 36 | `s12-easy-onset/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
| 9 | `s13-arpeggio-match/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | hold/progress stays ~0 without air/Space | hold=null remain=null engHold=0 |
| 10 | `s13-arpeggio-match/05_silence_after_2s.png` | Silence gate t=2s still silent | hold/progress still ~0 | hold=null remain=null live=true |
...
| 12 | `s13-arpeggio-match/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=false hold=null |
...
| 15 | `s13-arpeggio-match/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=false |
| 16 | `s13-arpeggio-match/07_space_short_release.png` | After short Space release | Still live | live=true |
| 17 | `s13-arpeggio-match/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 18 | `s13-arpeggio-match/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 19 | `s13-arpeggio-match/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 20 | `s13-arpeggio-match/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 21 | `s13-arpeggio-match/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 22 | `s13-arpeggio-match/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 23 | `s13-arpeggio-match/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 24 | `s13-arpeggio-match/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 25 | `s13-arpeggio-match/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 26 | `s13-arpeggio-match/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 27 | `s13-arpeggio-match/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 28 | `s13-arpeggio-match/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 29 | `s13-arpeggio-match/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 30 | `s13-arpeggio-match/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 31 | `s13-arpeggio-match/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 32 | `s13-arpeggio-match/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 33 | `s13-arpeggio-match/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 34 | `s13-arpeggio-match/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 35 | `s13-arpeggio-match/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 36 | `s13-arpeggio-match/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
**Notes:**
- Profile mode=staccatoLegato showPitch=true soundGated=false airHold=false wallClockPhase=true allowManual=true
- Mic drag 9→2 (restored)
- Silence 2s: airHold=false gated=false hold null→null remain 90→87 progress 0→0 PASS
- Space assist disabled on pure pitch highway (product)
- Space long: live mid/after=true/true manualChip=false engManual=false hold=null; short tap live=true; assistAllowed=false
...
| 9 | `s14-staccato-legato/05_silence_before.png` | Silence gate t=0 (silent mic, no Space) | phase timer may tick; not sound-count | hold=null remain=90 engHold=0 |
| 10 | `s14-staccato-legato/05_silence_after_2s.png` | Silence gate t=2s still silent | stable live | hold=null remain=87 live=true |
...
| 12 | `s14-staccato-legato/06_space_long_hold.png` | Space held ~1.1s | Still live; assist active if allowManualSound | live=true manual=false hold=null |
...
| 15 | `s14-staccato-legato/07_space_short_hold.png` | Space short hold 200ms | Still live; short press still prevents button activation | live=true manual=false |
| 16 | `s14-staccato-legato/07_space_short_release.png` | After short Space release | Still live | live=true |
| 17 | `s14-staccato-legato/08_live_s00_before.png` | Live second 0 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 18 | `s14-staccato-legato/08_live_s00_after.png` | Live second 0 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 19 | `s14-staccato-legato/08_live_s01_before.png` | Live second 1 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 20 | `s14-staccato-legato/08_live_s01_after.png` | Live second 1 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 21 | `s14-staccato-legato/08_live_s02_before.png` | Live second 2 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 22 | `s14-staccato-legato/08_live_s02_after.png` | Live second 2 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 23 | `s14-staccato-legato/08_live_s03_before.png` | Live second 3 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 24 | `s14-staccato-legato/08_live_s03_after.png` | Live second 3 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 25 | `s14-staccato-legato/08_live_s04_before.png` | Live second 4 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 26 | `s14-staccato-legato/08_live_s04_after.png` | Live second 4 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 27 | `s14-staccato-legato/08_live_s05_before.png` | Live second 5 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 28 | `s14-staccato-legato/08_live_s05_after.png` | Live second 5 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 29 | `s14-staccato-legato/08_live_s06_before.png` | Live second 6 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 30 | `s14-staccato-legato/08_live_s06_after.png` | Live second 6 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 31 | `s14-staccato-legato/08_live_s07_before.png` | Live second 7 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 32 | `s14-staccato-legato/08_live_s07_after.png` | Live second 7 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 33 | `s14-staccato-legato/08_live_s08_before.png` | Live second 8 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 34 | `s14-staccato-legato/08_live_s08_after.png` | Live second 8 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
| 35 | `s14-staccato-legato/08_live_s09_before.png` | Live second 9 before tick | Still live; highway/mode UI updating | hold=null status=En vivo manual=false |
| 36 | `s14-staccato-legato/08_live_s09_after.png` | Live second 9 after tick | No crash; counters only advance with sound/Space if gated | hold=null live=true |
...
## Root-cause analysis of prior test gaps (fixed 2026-07-17)

| Issue | Root cause | Fix |
|-------|------------|-----|
| False “hold=74→72” on diction | Probe treated first `.mode-big` / loose `[data-h]` as hold; rate ladder uses **wall-clock** `data-remain` countdown | Probe only `.mode-big[data-h]`; track `remainSec` separately; never silence-fail on remain |
| Null hold on pitch modes | Mode UI mounts in **`#mode-hud`** when `showPitch`, not `#mode-focus` | Probe both roots |
| s8 Space never assisted | `manualSoundAllowed()` returned false for **all** `showPitch` profiles; breath S needs Space/air | Allow Space for `breathS` / `manualSoundKind: "air"` even with pitch canvas; set `manualSoundKind: "air"` on s8 |
| Silence gate false confidence | Modes with null hold “passed” without measuring progress | Strict air-hold gate; progress proxy excludes remain |
| Space expected on pure highway | Product intentionally disables Space on pitch games | Assert no-stop only; document assist off |

Product code: `js/app.js` `manualSoundAllowed`, `js/practice-profiles.js` s8.
Test code: `tests/helpers/ui-forensics.js`, `tests/exercise-live-forensics.spec.js`.
