...
- Vinh Giang homework spine: diction, volume, soft palate, pen articulation, persona/story, connection, record-review, metaphors, 12-week focus.
- Live Music School spine: fry→closure→/A/ hold; solfège on progressions; song stanzas with note changes.
...
| S3 | Feel / Better Man | Reps + accuracy | Song-friendly progressions |
...
- **Progressions:** C/Am/F/G family and G/Em/C/D, F/C/Dm/Bb, Dm/Bb/F/C; song keys for Feel/Better Man practice.
