...
|----|-----|----------|--------|--------------|----------|
| VG-01 | Stripe/MP payment links empty; demo unlock on | P0 | **Open** | Paste live links; `demoUnlockEnabled:false` | billing-config.js |
...
| VG-06 | Trial auto-starts for all browsers | P2 | Open | Explicit opt-in trial start | Reverse trial tradeoff |
| VG-07 | 12-week plan weakly coupled to completions | P2 | Open | Plan→exercise deep links | Habit likelihood |
| VG-08 | Entitlement local-only / shareable | P2 | Open | Webhook + license | GH Pages constraint |
