...
(function (global) {
  ...
  const STRINGS = {
    es: {
      ...
      "auth.adminPage": "Abrir el panel de admin",
      ...
      "start.titleBack": "Llevas {n} sesión(es) guardadas",
    ...
    en: {
      ...
      "auth.adminPage": "Open the admin panel",
      ...
      "start.titleBack": "{n} session(s) saved so far",
