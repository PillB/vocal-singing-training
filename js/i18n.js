...
(function (global) {
  ...
  const STRINGS = {
    es: {
      ...
      "nav.account": "Cuenta",
      "auth.title": "Cuenta",
      "auth.sub": "Inicio de sesión opcional para testers. La práctica gratis nunca pide cuenta.",
    ...
    en: {
      ...
      "nav.account": "Account",
      "auth.title": "Account",
      "auth.sub": "Optional sign-in for testers. Free practice never needs an account.",
