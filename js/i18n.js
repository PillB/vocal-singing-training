...
(function (global) {
  ...
  const STRINGS = {
    es: {
      ...
      "pricing.feat.multi_profile": "Varios perfiles (próximamente)",
      "pricing.feat.pro_insights": "Insights de coach automáticos en «Tu estudio»",
      "pricing.feat.coach_pack": "Resumen coach descargable (texto + JSON)",
    ...
    en: {
      ...
      "pricing.feat.multi_profile": "Multi-profile (coming soon)",
      "pricing.feat.pro_insights": "Automatic coach insights on Your studio",
      "pricing.feat.coach_pack": "Downloadable coach summary (text + JSON)",
