...
export const SCENARIO_BY_MODE = {
  rateLadder: "rateSteps",
  volumeSteady: "count",
  countPace: "countNumbers",
  articulationContrast: "countBeat",
  recordOnly: "speech",
  speechEnergy: "turnTaking",
  reviewSession: "longTake",
  metronomeSpeech: "topicTalk",
  weekPlan: "silent",
  pauseDetect: "speech",
  fillerDetect: "fillerTalk",
  pitchContour: "cadence",
  volumeLadder: "ladder",
  keyPointPace: "keyPoints",
  gestureReps: "speech",
  facePhases: "speech",
  concisionGate: "qaGate",
  storyTimer: "story",
  authorityLand: "claims",
  energyMatch: "energyTakes",
  pitchHold: "fryClear",
  pitchChord: "follow",
  pitchSong: "songPhrases",
  shAirLadder: "airLadder",
  scaleSteps: "follow",
  releaseFlow: "silent",
  breathCycle: "breath",
  openSpace: "palateLouder",
  vowelLadder: "vowels",
  resonanceZone: "zones",
  placementAB: "abTakes",
  trillSolfege: "trill",
  sovtFlow: "trillStops",
  sirenRange: "sirenBreak",
  humTargets: "follow",
  breathS: "sThenA",
  pitchMatch: "matchListen",
